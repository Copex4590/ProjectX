...
```bash
git tag -a v0.3.1-beta -m "Project X 0.3.1-beta"
...
5. Paste release notes from `release/notes/0.3.1-beta.md` or `docs/RELEASE_NOTES_v0.3.1-beta.md`.
...
|-------|----------------|
| Application | `0.3.1-beta` (`src/version.py`) |
| Manifest | `0.3.1-beta` |
| Website `latest` | `0.3.1-beta` |
