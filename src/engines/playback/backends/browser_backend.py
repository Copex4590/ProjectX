# ============================================================================
# Project X
# Browser Backend (architecture stub)
# ============================================================================
...
_SUPPORTED_PROVIDERS = frozenset({"hls", "youtube"})


class BrowserBackend(PlaybackBackend):
    ...
    def start(self, session: PlaybackSession) -> PlaybackSession:
        ...
        return session.with_state(
            ...
            message="Browser backend start prepared",
    ...
    def stop(self, session: PlaybackSession) -> PlaybackSession:
        ...
        return session.with_state(
            ...
            message="Browser backend stopped",
