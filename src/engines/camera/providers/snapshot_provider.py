# ============================================================================
# Project X
# Snapshot Provider (architecture stub)
# ============================================================================
...
class SnapshotProvider(CameraProvider):
    ...
    def supports(self, camera: Camera) -> bool:
        ...
        if provider_type in {"snapshot", "image", "jpeg", "jpg", "png"}:
            return bool(stream_url)

        return any(
            stream_url.endswith(extension)
    ...
    def open(self, camera: Camera) -> ProviderSession | None:
        ...
        if not self.supports(camera):
            ...
            self._message = "Camera is not supported by Snapshot provider"
            return None
        ...
        self._message = "Snapshot session prepared"
